...
const SideBarUsers = (props) => {
  const menuItem = [
    ...
    {
      path: "/users/create-complain",
      name: "Create Complain",
      icon: <GrCompliance color="grey" />,
    },

    {
      path: "/users/get-complains",
      name: "All Complains",
      icon: <MdOutlineFeed />,
    },
    {
      path: "/users/change-request",
      name: "Room Change",
      icon: <FaExchangeAlt />,
    },
    {
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          {menuItem.map((m, i) => {
            return (
              <>
                <NavLink to={m.path} key={i} style={{ textDecoration: "none" }}>
                  <ListItem
                    key={i}
                    disablePadding
